...
public class ActionBarSherlockNative extends ActionBarSherlock {
    ...
    public boolean dispatchCreateOptionsMenu(android.view.Menu menu) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchCreateOptionsMenu] menu: " + menu);
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchCreateOptionsMenu] returning " + result);
        return result;
    }

    @Override
    public boolean dispatchPrepareOptionsMenu(android.view.Menu menu) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPrepareOptionsMenu] menu: " + menu);
    ...
    public boolean dispatchOptionsItemSelected(android.view.MenuItem item) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchOptionsItemSelected] item: " + item.getTitleCondensed());
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchOptionsItemSelected] returning " + result);
        return result;
    }

    @Override
    public boolean hasFeature(int feature) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[hasFeature] feature: " + feature);
    ...
    public boolean requestFeature(int featureId) {
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[requestFeature] returning " + result);
        return result;
    }
