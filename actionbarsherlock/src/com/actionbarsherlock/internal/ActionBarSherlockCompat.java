...
import com.actionbarsherlock.SherlockConfig;
...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public ActionBar getActionBar() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[getActionBar]");
    ...
    private void initActionBar() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[initActionBar]");
    ...
    public void setTitle(CharSequence title) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setTitle] title: " + title);
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[startActionMode] callback: " + callback);
    ...
    public void dispatchConfigurationChanged(Configuration newConfig) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchConfigurationChanged] newConfig: " + newConfig);
    ...
    public void dispatchPostResume() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPostResume]");
    ...
    public void dispatchPause() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPause]");
    ...
    public void dispatchStop() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchStop]");
    ...
    public void dispatchInvalidateOptionsMenu() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchInvalidateOptionsMenu]");
    ...
    public boolean dispatchOpenOptionsMenu() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchOpenOptionsMenu]");
    ...
    public boolean dispatchCloseOptionsMenu() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchCloseOptionsMenu]");
    ...
    public void dispatchPostCreate(Bundle savedInstanceState) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchOnPostCreate]");
    ...
    public boolean dispatchPrepareOptionsMenu(android.view.Menu menu) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPrepareOptionsMenu] android.view.Menu: " + menu);
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPrepareOptionsMenu] returning " + result);
        return result;
    }
    ...
    public boolean dispatchMenuOpened(int featureId, android.view.Menu menu) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchMenuOpened] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchPanelClosed(int featureId, android.view.Menu menu){
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchPanelClosed] featureId: " + featureId + ", menu: " + menu);
    ...
    public void dispatchTitleChanged(CharSequence title, int color) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchTitleChanged] title: " + title + ", color: " + color);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchKeyEvent] event: " + event);
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (mActionMode != null) {
                ...
                if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchKeyEvent] returning true");
                return true;
            }
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[dispatchKeyEvent] returning false");
        return false;
    }
    ...
    public boolean onMenuItemClick(android.view.MenuItem item) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[mNativeItemListener.onMenuItemClick] item: " + item);
    ...
    public void setProgressBarVisibility(boolean visible) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setProgressBarVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminateVisibility(boolean visible) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setProgressBarIndeterminateVisibility] visible: " + visible);
    ...
    public void setProgressBarIndeterminate(boolean indeterminate) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setProgressBarIndeterminate] indeterminate: " + indeterminate);
    ...
    public void setProgress(int progress) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setProgress] progress: " + progress);
    ...
    public void setSecondaryProgress(int secondaryProgress) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setSecondaryProgress] secondaryProgress: " + secondaryProgress);
    ...
    private int getFeatures() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[getFeatures] returning " + mFeatures);
    ...
    public boolean hasFeature(int featureId) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[hasFeature] featureId: " + featureId);

        boolean result = (mFeatures & (1 << featureId)) != 0;
        if (SherlockConfig.DEBUG) Log.d(TAG, "[hasFeature] returning " + result);
        return result;
    }

    @Override
    public boolean requestFeature(int featureId) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[requestFeature] featureId: " + featureId);
    ...
    public void setUiOptions(int uiOptions) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setUiOptions] uiOptions: " + uiOptions);
    ...
    public void setUiOptions(int uiOptions, int mask) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setUiOptions] uiOptions: " + uiOptions + ", mask: " + mask);
    ...
    public void setContentView(int layoutResId) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setContentView] layoutResId: " + layoutResId);
    ...
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[setContentView] view: " + view + ", params: " + params);
    ...
    public void addContentView(View view, ViewGroup.LayoutParams params) {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[addContentView] view: " + view + ", params: " + params);
    ...
    private void installDecor() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[installDecor]");
    ...
    private ViewGroup generateLayout() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[generateLayout]");
        ...
        if (SherlockConfig.DEBUG) Log.d(TAG, "[generateLayout] using screen XML " + mActivity.getResources().getString(layoutResource));
    ...
    private static int loadUiOptionsFromManifest(Activity activity) {
        ...
        try {
            ...
            if (SherlockConfig.DEBUG) Log.i(TAG, "Parsing AndroidManifest.xml for " + thisPackage);
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if ("application".equals(name)) {
                        ...
                        if (SherlockConfig.DEBUG) Log.d(TAG, "Got <application>");

                        for (int i = xml.getAttributeCount() - 1; i >= 0; i--) {
                            if (SherlockConfig.DEBUG) Log.d(TAG, xml.getAttributeName(i) + ": " + xml.getAttributeValue(i));
                        ...
                        if (SherlockConfig.DEBUG) Log.d(TAG, "Got <activity>");
        ...
        if (SherlockConfig.DEBUG) Log.i(TAG, "Returning " + Integer.toHexString(uiOptions));
        return uiOptions;
    }
    ...
    public void ensureActionBar() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[ensureActionBar]");
