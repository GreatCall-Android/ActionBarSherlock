...
public class SherlockFragmentActivity extends Watson implements OnActionModeStartedListener, OnActionModeFinishedListener {
    ...
    public MenuInflater getSupportMenuInflater() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[getSupportMenuInflater]");

        return getSherlock().getMenuInflater();
    }

    public void invalidateOptionsMenu() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[invalidateOptionsMenu]");

        getSherlock().dispatchInvalidateOptionsMenu();
    }

    public void supportInvalidateOptionsMenu() {
        if (SherlockConfig.DEBUG) Log.d(TAG, "[supportInvalidateOptionsMenu]");
    ...
    public final boolean onMenuItemSelected(int featureId, android.view.MenuItem item) {
        ...
        if (featureId == Window.FEATURE_OPTIONS_PANEL && !mIgnoreNativeSelected) {
            ...
            if (SherlockConfig.DEBUG) Log.d(TAG, "[onMenuItemSelected] returning " + result);
            return result;
        }
